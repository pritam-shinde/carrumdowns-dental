...
const CranbourneWest = () => {
  ...
  return (
    <>
      ...
      <CommonHero bg={Banner} breadcrumb={breadcrumb} title="We are your go-to Dentist in Cranbourne West" align="left" color="#fff" />
      <main>
              ...
              <Box py={5}>
                <Grid container spacing={5}>
                  <Grid item xs={12} lg={8}>
                    <Box>
                      <Image src={CranbourneWestClinic}  className='img-fluid' alt="Dentist in Cranbourne West" />
                    </Box>
