...
const SleepDentistry = () => {
  ...
  return (
    <>
      <Head>
        <title>Sleep Dentistry Services for Stress-Free Dental Treatments</title>
        <meta name="description" content="Experience sleep dentistry in Carrum Downs with skilled dental sleep professionals. Enjoy comfortable, anxiety-free treatments for a stress-free dental visit." />
        <meta name="robots" content="index" />
      </Head>
      <CommonHero bg={Banner} breadcrumb={breadcrumb} align ='left' color="#fff" title="Expert Sleep Dentistry Services" />
              ...
              <Grid container spacing={4}>
                <Grid item xs={12} md={6} className="mt-2">
                  <Box sx={{ width: "100%", height: "auto" }}>
                    <Image src={SleepDentistryWhat} alt="Sleep Dentistry Carrum Downs" priority layout="responsive" width={550} height={500} style={{ maxWidth: "100%", height: "auto" }} className="object-cover" />
                  </Box>
                </Grid>
              ...
              <Grid container justifyContent="center" spacing={4} mb={2}>
                <Grid item xs={12} md={4} sm={6}>
                  <Card className={styles.card}>
                    <Image src={Image1} alt="scale and clean" width={440} height={290} className={styles.cardImage} style={{ aspectRatio: "6/4" }} />
                ...
                <Grid item xs={12} md={4} sm={6}>
                  <Card className={styles.card}>
                    <Image src={Image2} alt="scale and clean" width={440} height={290} className={styles.cardImage} />
                    <CardContent className={styles.cardContent}>
                ...
                <Grid item xs={12} md={4} sm={6}>
                  <Card className={styles.card}>
                    <Image src={Image3} alt="scale and clean" width={440} height={290} className={styles.cardImage} />
                    <CardContent className={styles.cardContent}>
                      <Typography variant="h5" component="h3" className=" maintainance-title-font veneer-font-color fs-4">
            ...
            <Grid item xs={12} md={9} className="mx-auto pb-4">
              <Grid container justifyContent="center" spacing={4}>
                <Grid item xs={12} md={6} sm={6} lg={4}>
                  <Card className={styles.card}>
                    <CardMedia component="img" src={HappyGas.src} alt="Happy Gas Treatment" width={440} height={350} style={{ aspectRatio: "5/4" }} className={styles.ChoosecardImage} />
                ...
                <Grid item xs={12} md={6} sm={6} lg={4}>
                  <Card className={styles.card}>
                    <CardMedia component="img" src={Sedation.src} alt="Sedation Dentistry" width={440}
                ...
                <Grid item xs={12} md={6} sm={6} lg={4}>
                  <Card className={styles.card}>
                    <CardMedia component="img" src={Twilight.src} alt="Twilight Sedation" className={styles.ChoosecardImage} width={440}
      ...
      <section className="py-4 my-4" style={{ background: "#d1cbcb52" }}>
        <Container maxWidth="lg">
          <Grid container spacing={4} alignItems="center">
            ...
            <Grid item xs={12} md={6}>
              <Box sx={{ width: "100%" }}>
                <Image src={Doctor2} alt="Sleep Dentistry Carrum Downs" width={600} height={400} className="w-full h-auto object-cover rounded-lg shadow-md" priority />
              </Box>
            </Grid>
