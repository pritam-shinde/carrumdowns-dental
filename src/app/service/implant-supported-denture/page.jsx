...
const Implant = () => {
  ...
  return (
    <>
      <Head>
        <title>Restore Your Smile with Dental Implants and Dentures</title>
        <meta name="description" content="Get secure and comfortable dental implants and dentures in Carrum Downs. Secure, natural-looking solutions for missing teeth that offer comfort & lasting results."
        />
