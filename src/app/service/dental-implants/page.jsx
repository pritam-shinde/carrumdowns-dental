                                    ...
                                    <Grid item xs={12} lg={8}>
                                        <section>
                                            <Container maxWidth="xxl" className="p-0">
                                                ...
                                                >
                                                    <iframe
                                                        src="//fast.wistia.net/embed/iframe/9996c81a28?playerColor=8c8c8c&videoFoam=true"
                                                    ...
                                                    <List>
                                                        <ListItem className="ps-0">
                                                            ...
                                                            <ListItemText
                                                                primary={
                                                                    <strong>
                                                                        Complete Dental Implants with Crown normally
                                                                        $4500* is special on $3900*.
                                                                    </strong>
                                                                }
                                                            />
                                                        </ListItem>
                                                ...
                                                <Typography className="para">
                                                    Dental Implants with Crown have quickly become a very effective way
                                                    for patients to deal with tooth loss. The dental Implants along with
                                                    restoring the functionality of the tooth also increase an
                                                    individual’s confidence to lead a normal life.
                                                </Typography>
                                                <Typography className="para">
                                                    Carrum Downs Dental Group’s Dental Implants are made from Titanium,
                                                    a very strong material that is also compatible with human body. A
                                                    crown placed on top of it will make it appear and function as a
                                                    normal tooth and provides up to 90% chewing capacity.
                                                </Typography>
                                            </Container>
                                                            ...
                                                            <List>
                                                                <ListItem className="p-0">
                                                                    ...
                                                                    <ListItemText
                                                                        primary={
                                                                            <>
                                                                                Dental Implants are the best alternative
                                                                                for{" "}
                                                        ...
                                                        <div className="accordion" id="accordionExample">
                                                                ...
                                                                >
                                                                    <div className="accordion-body">
                                                                        <p className="para">
                                                                            ...
                                                                            alternative for lost teeth because they can
                                                                            last for a lifetime. With regular brushing,
                                                                            flossing and dental check-ups, they can
                                                                            offer a permanent solution. The crown,
                                                                            however, only lasts between 10 to 15 years
                                                                ...
                                                                >
                                                                    <div className="accordion-body">
                                                                        <p className="para">
                                                                            ...
                                                                            anaesthesia to numb the site of the implant.
                                                                            After the procedure, however, some patients
                                                                            may experience a mild, which can be relieved
                                                                            using painkillers.
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                >
                                                                    <div className="accordion-body">
                                                                        <p className="para">
                                                                            ...
                                                                            technique your dentist decides to use and
                                                                            the location of the implant. Generally, it
                                                                            takes about 1 hour to place the implant.
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div className="accordion-item">
                                                                ...
                                                                >
                                                                    <div className="accordion-body">
                                                                        <p className="para">
                                                                            Dental implants have been done safely for
                                                                            over 50 years with up to 98% success rate.
                                                                            This means it’s safe for almost anyone so
                                                                            long as your oral health is good.
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
