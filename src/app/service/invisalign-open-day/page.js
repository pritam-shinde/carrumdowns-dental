...
export const metadata = {
  title: "Smile Confidently with Clear Aligner Invisalign Treatment",
  description: "Get the smile you want with clear aligner invisalign in Carrum Downs. Comfortable and invisible treatment to straighten your teeth and boost your confidence.",
  robots: "index",
  alternates: { canonical: "/service/invisalign-open-day", },
};

const InvisalignOpenDay = () => {
  const breadcrumb = [
  ...
  return (
    <>
      <CommonHero bg={Banner} breadcrumb={breadcrumb} title="Clear Aligner Invisalign Service for a Straighter Smile" align="left" color="#fff" />
      <main>
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12} lg={8}>
                    ...
                    <section className='mt-md-5 mt-4'>
                      <Container maxWidth="xxl" className='p-0'>
                        <Box p={3}>
                          <SectionalHeading variant="h2" title="What are Invisalign clear braces?" align='left' color="var(--dark-blue)" />
