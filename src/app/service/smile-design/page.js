...
const SmileDesign = () => {
  ...
  return (
    <>
      ...
      <CommonHero bg={Banner} breadcrumb={breadcrumb} title="Smile Design" align ='left' color="#fff" />
                    ...
                    <Grid container spacing={3}>
                      <Grid item xs={12} lg={8}>
                        ...
                        <section className='mt-md-5 mt-4 bg-grey'>
                          <Container maxWidth="xxl" className='p-0'>
                            <Box p={3}>
                              <SectionalHeading variant="h2" title="What is Smile Design?" align ='left' color="var(--dark-blue)" />
                        ...
                        <section className='mt-md-5 mt-4'>
                          <Container maxWidth="xxl" className='p-0'>
                            ...
                            <Box mt={3}>
                              <Grid container>
                                <Grid item xs={12}>
                                  <Image src={image2} alt="smile" className='img-fluid' />
                                </Grid>
                                <Grid item xs={12}>
                                  <List>
                                    <ListItem>
                            ...
                            <Box p={3}>
                              ...
                              <Box mt={3}>
                                <Grid container spacing={5}>
                                  ...
                                  <Grid item xs={12} md={6}>
                                    <Image src={image3} alt="smile" className='img-fluid'/>
                                  </Grid>
                                </Grid>
                              </Box>
                            </Box>
