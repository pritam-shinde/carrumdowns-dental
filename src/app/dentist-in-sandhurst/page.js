                ...
                <Box py={5}>
                  <Grid container spacing={5}>
                    <Grid item xs={12} lg={8}>
                      <section>
                        <Container maxWidth="xxl">
                          <Image src={SandhurstClinic} alt="Dentist In Sandhurst" className='img-fluid'/>
                          <Box mt={2}>
                            <SectionalHeading variant="h2" title="Get the Best Dental Care at Sandhurst" align="left" color="var(--dark-blue)" />
                            <Typography className='para mt-2'>At Carrum Downs Dental, providing care to patients is our top priority. From ensuring that practices have convenient appointment times to educating all our patients about good dental hygiene at home- every single aspect of your dental care is carefully considered.</Typography>
