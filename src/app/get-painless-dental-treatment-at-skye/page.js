...
export const metadata = {
    ...
    robots: "index",
    alternates: { canonical: "/get-painless-dental-treatment-at-skye/", },
};
...
const Skye = () => {
    ...
    return (
        <>
            <CommonHero bg={Banner} breadcrumb={breadcrumb} title="Get Painless Dental Treatment at Skye" align="left" color="#fff" />
            <main>
