...
export const metadata = {
  title: "Dentist in Seaford | Carrum Downs Dental Group",
  ...
  robots: "index",
  alternates: { canonical: "/find-the-best-dentist-in-seaford/", },
};
...
const SeaFord = () => {
  ...
  return (
    <> 
      <CommonHero breadcrumb={breadcrumb} bg={Banner} title="Find the best dentist in Seaford" align="left" color="#fff" />
      <main>
              ...
              <Box py={5}>
                <Grid container spacing={5}>
                  <Grid item xs={12} lg={8}>
                    <Box>
                      <Image src={SeafordClinic} alt="Dentist in Seaford"  className='img-fluid'/>
                      <Box mt={1}>
