                  ...
                  <Grid container spacing={5}>
                    <Grid item xs={12} lg={8}>
                      ...
                      <section className='mt-md-5 mt-4'>
                        <Container maxWidth="xxl">
                          <Image src={AfterPay} alt="afterPay" className='img-fluid'/>
                      ...
                      <section className='mt-md-5 mt-4'>
                        <Container maxWidth="xxl">
                          <Box className='d-flex justify-content-center align-items-center'>
                            <Image src={MySmileLogo} alt="my smile logo" className='img-fluid'/>
                          </Box>
                          <Image src={MySmile} alt="my smile plan" className='img-fluid'/> 
                        </Container>
                      </section>
                      <section className='mt-md-5 mt-4'>
                        <Container maxWidth="xxl" className='shadow py-3'>
                          <Grid container spacing={3}>
                            <Grid item xs={12} md={4} className="d-flex justify-content-center align-items-center">
                              <Image src={Denticare} alt="denticare badge" className='img-fluid'/>
                            </Grid>
                            <Grid item xs={12} md={8}>
                              <Box>
                                <SectionalHeading title="Your Plan For A Better You" variant="h2" align="left" color="var(--dark-blue)" />
