...
const AccessMySuper = () => {
    ...
    return (
        <>
            ...
            <CommonHero bg={SuperBg} breadcrumb={breadcrumb} align="left" title="Access My Super" color="#ccc" />
            <main>
                <section>
                                        ...
                                        <Grid item xs={12} lg={8}>
                                                ...
                                                <Container maxWidth="xxl" className='shadow py-3'>
                                                    <Grid container spacing={3}>
                                                        <Grid item xs={12} md={4} className="d-flex justify-content-center align-items-center">
                                                            <Image src={Super2} alt="denticare badge"  className='img-fluid'/>
                                                        </Grid>
                                                        <Grid item xs={12} md={8}>
                                                            <Box>
                                                                <SectionalHeading title="What is acute dental pain?" variant="h2" align="left" color="var(--dark-blue)" />
                                            ...
                                            <section className='mt-md-5 mt-4 bg-light'>
                                                <Container maxWidth="xxl" className='shadow py-3'>
                                                    <Grid container spacing={3}>
                                                        <Grid item xs={12} md={4} className="d-flex justify-content-center align-items-center">
                                                            <Image src={Super1} alt="denticare badge" className='img-fluid'/>
                                                        </Grid>
                                                        <Grid item xs={12} md={8}>
                                                            <Box>
                                                                <SectionalHeading title="What Procedures Can I Access My Super for?" variant="h2" align="left" color="var(--dark-blue)" />
