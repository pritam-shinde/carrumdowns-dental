...
import { Box, Container, Grid, List, ListItem, ListItemIcon, ListItemText, Tab, Tabs, Typography } from "@mui/material";
                                                                ...
                                                                <List>
                                                                    ...
                                                                    <Box mt={3}>
                                                                        <Button
                                                                            ...
                                                                            onClick={() =>
                                                                                setSelectedTab("Denture (Traditional)")
                                                                            }
                                                                        >
                                                                            <a
                                                            ...
                                                            <Box p={1}>
                                                                ...
                                                                <Box mt={3}>
                                                                    <Button
                                                                        style={{ width: "10rem" }}
                                                                        className="teethWhiteningBtn"
                                                                        onClick={() => setSelectedTab("Overdenture")}
                                                                    >
                                                                        <a
...
export default DentureTechnologyClient;
