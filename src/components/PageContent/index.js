...
import ChippedOrCrackedTooth from "../../../public/dental-problems-img/chipped or cracked tooth/chipped_teeth_new.png";
...
const PageContent = ({ selectedTab }) => {
  const pageData = [
    ...
    },
    {
      title: "Crooked Teeth",
      content:
        "Misaligned teeth aren't solely a cosmetic concern; they can also give rise to significant oral health complications. Pursuing treatment for crooked teeth is crucial to address both aesthetic and dental considerations.",
    ...
    },
    {
      title: "Gum Disease",
      content:
        "If you're facing issues with gum disease, Carrum Downs Dental Group is here to provide assistance. Our advanced techniques and cutting-edge facilities enable us to deliver effective gum disease treatments.",
      imageSrc: GumDisease,
    ...
    },
    {
      title: "Stained Teeth",
      content:
        "Perhaps discoloured or stained teeth have caused you to feel less confident about sharing your smile. At Carrum Downs Dental Group, we have the solution to boost your confidence.",
