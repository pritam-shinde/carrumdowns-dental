        ...
        <Grid container>
          <Grid item xs={width <= 1450 ? 11 : 10}>
            <Box className="d-flex">
              {
                [
                  { id: "topbar-item-1", icon: <AccessTime className={`${Styles.topbarIcons}`} />, text: "<strong>Mon to Sun:</strong> <span>9AM - 5PM</span>" },
                  // { id: "topbar-item-4", icon: <AccessTime className={`${Styles.topbarIcons}`} />, text: "<strong>Sun :</strong> <span>9AM - 5PM</span>" },
